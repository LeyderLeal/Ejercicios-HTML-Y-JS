...
function init(){
	...
	var potenciacion = document.getElementById("potenciacion");
	var raizcuadrada = document.getElementById("raiz2");
  ...
  var cero = document.getElementById("cero");
    ...
    potenciacion.onclick = function(e){
    	operandoa = resultado.textContent;
    	operacion = "^";
    	limpiar();
    }
    raiz2.onclick = function(e){
    	operandoa = resultado.textContent;
    	operacion = "√";
    	limpiar();
    }
